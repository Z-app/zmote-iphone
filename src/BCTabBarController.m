...
- (void)loadView {
    ...
    /* Below sets position and size of the tabbed bar frame */
    self.tabBar = [[BCTabBar alloc] initWithFrame:CGRectMake(0, 35, self.view.bounds.size.width, tabBarHeight + adjust)];
    ...
    //VIKTOR
    NSInteger bottomLineThickness = 2;
    UIView* bottomLine = [[UIView alloc] initWithFrame:CGRectMake(0,tabBar.frame.size.height - bottomLineThickness, self.view.frame.size.width, bottomLineThickness)];
    bottomLine.backgroundColor = RGBCOLOR(56, 56, 56);
