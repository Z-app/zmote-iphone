...
- (void)drawRect:(CGRect)rect {
	if (self.selected) {
        ...
        /* Lower line on selected tab */
		[RGBCOLOR(48, 180, 224) set];
		CGContextFillRect(c, CGRectMake(0, (6*self.bounds.size.height) / 7, self.bounds.size.width, self.bounds.size.height / 7));
